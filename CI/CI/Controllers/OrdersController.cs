...
namespace CI.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,ProductID,CustomerID,Qty,Price,TotalPrice")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ProductID,CustomerID,Qty,Price,TotalPrice")] Order order)
        {
            if (ModelState.IsValid)
            {
